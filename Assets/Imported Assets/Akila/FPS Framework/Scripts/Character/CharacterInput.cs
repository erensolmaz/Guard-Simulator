...
namespace Akila.FPSFramework
{
    ...
    public class CharacterInput : MonoBehaviour
    {
        ...
        ///Inventory input
        public virtual bool item1 => IsInputAllowed && controls.Player.Item1.triggered;
        public virtual bool item2 => IsInputAllowed && controls.Player.Item2.triggered;
        public virtual bool item3 => IsInputAllowed && controls.Player.Item3.triggered;
        public virtual bool item4 => IsInputAllowed && controls.Player.Item4.triggered;
        public virtual bool item5 => IsInputAllowed && controls.Player.Item5.triggered;
        public virtual bool item6 => IsInputAllowed && controls.Player.Item6.triggered;
        public virtual bool item7 => IsInputAllowed && controls.Player.Item7.triggered;
        public virtual bool item8 => IsInputAllowed && controls.Player.Item8.triggered;
        public virtual bool item9 => IsInputAllowed && controls.Player.Item9.triggered;

        public virtual bool itemUp => IsInputAllowed && controls.Player.SwitchItem.ReadValue<float>() > 0;
        public virtual bool itemDown => IsInputAllowed && controls.Player.SwitchItem.ReadValue<float>() < 0;

        public virtual bool itemNext => IsInputAllowed && controls.Player.NextItem.triggered;
        public virtual bool itemPrevious => IsInputAllowed && controls.Player.PreviousItem.triggered;

        public virtual bool defaultItem => IsInputAllowed && controls.Player.DefaultItem.triggered;
