...
namespace Akila.FPSFramework
{
    ...
    public class FirstPersonController : MonoBehaviour, ICharacterController
    {
        ...
        protected virtual void Awake()
        {
            ...
            {
                onJumpVelcoity = velocity.magnitude * (velocity.normalized * (1 - momentumLoss));
            });
        ...
        private Vector3 GetTransformVelocity(Transform hitTransform)
        {
            ...
            if (speedometer.TryGetComponent<Ignore>(out Ignore ignore) && ignore.ignoreMovingPlatform) 
                return Vector3.zero;
