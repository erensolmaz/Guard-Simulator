            ...
            get
            {
                ...
                try
                {
                    if (audioHolder == null)
                    {
                        ...
                        AudioHolder holder = audioHolder.AddComponent<AudioHolder>();
                        ...
                        audioHolder.hideFlags = HideFlags.HideInInspector | HideFlags.HideInHierarchy;
                    }
                }
                catch (Exception e)
                {
            ...
            while (time < eventsDuration + Time.deltaTime)
            {
                ...
                foreach (CustomAudioEvent customEvent in events)
                {
                    ...
                    if (currentTime > customEvent.time && previousTime < customEvent.time)
                    {
                        ...
                        if (isEventsEnabled && component && component.gameObject.activeInHierarchy)
                            customEvent?.Invoke();
                    }
                }
